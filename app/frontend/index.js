...
var $author$project$Main$Coordinate = F2(
	function (lat, lon) {
...
var $matheus23$elm_default_tailwind_modules$Tailwind$Utilities$appearance_none = $rtfeldman$elm_css$Css$batch(
	_List_fromArray(
		[
			A2($rtfeldman$elm_css$Css$property, '-webkit-appearance', 'none'),
...
var $matheus23$elm_default_tailwind_modules$Tailwind$Utilities$bg_transparent = A2($rtfeldman$elm_css$Css$property, 'background-color', 'transparent');
var $rtfeldman$elm_css$Css$borderColor = function (c) {
	return A2($rtfeldman$elm_css$Css$property, 'border-color', c.value);
};
var $matheus23$elm_default_tailwind_modules$Tailwind$Utilities$border_none = A2($rtfeldman$elm_css$Css$property, 'border-style', 'none');
...
var $author$project$Util$colorBlue = $rtfeldman$elm_css$Css$hex('#0A4DD0');
var $author$project$Util$colorGreen = $rtfeldman$elm_css$Css$hex('#53AC42');
...
var $rtfeldman$elm_css$Css$inherit = _Utils_update(
	...
	{value: 'inherit'});
var $matheus23$elm_default_tailwind_modules$Tailwind$Utilities$leading_normal = A2($rtfeldman$elm_css$Css$property, 'line-height', '1.5');
...
var $matheus23$elm_default_tailwind_modules$Tailwind$Utilities$p_3 = A2($rtfeldman$elm_css$Css$property, 'padding', '0.75rem');
...
var $matheus23$elm_default_tailwind_modules$Tailwind$Utilities$rounded_lg = A2($rtfeldman$elm_css$Css$property, 'border-radius', '0.5rem');
...
var $matheus23$elm_default_tailwind_modules$Tailwind$Utilities$underline = A2($rtfeldman$elm_css$Css$property, 'text-decoration', 'underline');
...
var $author$project$Util$localStyle = $rtfeldman$elm_css$Css$batch(
	_List_fromArray(
		[
			...
			_List_fromArray(
				[
					$rtfeldman$elm_css$Css$qt('Open Sans'),
					function ($) {
					return $.value;
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							$rtfeldman$elm_css$Css$color($author$project$Util$colorBlue),
							$matheus23$elm_default_tailwind_modules$Tailwind$Utilities$underline
						]))
				])),
			$rtfeldman$elm_css$Css$Global$descendants(
			_List_fromArray(
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							$matheus23$elm_default_tailwind_modules$Tailwind$Utilities$appearance_none,
							$matheus23$elm_default_tailwind_modules$Tailwind$Utilities$bg_transparent,
							$matheus23$elm_default_tailwind_modules$Tailwind$Utilities$border_none,
							$matheus23$elm_default_tailwind_modules$Tailwind$Utilities$p_3,
							...
							A2($rtfeldman$elm_css$Css$property, 'grid-area', 'select'),
			...
			_List_fromArray(
				[
					...
					'*',
					_List_fromArray(
						[$matheus23$elm_default_tailwind_modules$Tailwind$Utilities$box_border, $matheus23$elm_default_tailwind_modules$Tailwind$Utilities$leading_normal]))
				]))
		]));
var $rtfeldman$elm_css$Css$maxWidth = $rtfeldman$elm_css$Css$prop1('max-width');
var $rtfeldman$elm_css$Css$minWidth = $rtfeldman$elm_css$Css$prop1('min-width');
var $matheus23$elm_default_tailwind_modules$Tailwind$Utilities$mx_auto = $rtfeldman$elm_css$Css$batch(
	_List_fromArray(
		[
...
var $author$project$Util$btn = A2(
	$rtfeldman$elm_css$Html$Styled$styled,
	$rtfeldman$elm_css$Html$Styled$button,
	_List_fromArray(
		[$matheus23$elm_default_tailwind_modules$Tailwind$Utilities$text_lg, $matheus23$elm_default_tailwind_modules$Tailwind$Utilities$p_4, $matheus23$elm_default_tailwind_modules$Tailwind$Utilities$w_full, $matheus23$elm_default_tailwind_modules$Tailwind$Utilities$rounded_md, $matheus23$elm_default_tailwind_modules$Tailwind$Utilities$cursor_pointer]));
...
var $author$project$Util$btnGreen = F2(
	function (attr, h) {
		return A2(
			...
			_Utils_ap(
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$rtfeldman$elm_css$Css$backgroundColor($author$project$Util$colorGreen),
				...
				[
					...
					_List_fromArray(
						[
							...
							$matheus23$elm_default_tailwind_modules$Tailwind$Utilities$z_30
						]))
				]),
			_List_fromArray(
				[
...
var $author$project$Main$viewStartContent = A2(
	...
	_List_fromArray(
		[
			...
			_List_fromArray(
				[
					$matheus23$elm_default_tailwind_modules$Tailwind$Utilities$grid,
					$matheus23$elm_default_tailwind_modules$Tailwind$Utilities$relative,
					$matheus23$elm_default_tailwind_modules$Tailwind$Utilities$gap_6,
					$matheus23$elm_default_tailwind_modules$Tailwind$Breakpoints$md(
					_List_fromArray(
						[$matheus23$elm_default_tailwind_modules$Tailwind$Utilities$grid_cols_2, $matheus23$elm_default_tailwind_modules$Tailwind$Utilities$gap_0]))
				]))
		]),
	_List_fromArray(
		[
			...
			_List_fromArray(
				[
					$rtfeldman$elm_css$Html$Styled$Attributes$css(
					_List_fromArray(
						[$matheus23$elm_default_tailwind_modules$Tailwind$Utilities$relative, $matheus23$elm_default_tailwind_modules$Tailwind$Utilities$p_10, $matheus23$elm_default_tailwind_modules$Tailwind$Utilities$text_center, $matheus23$elm_default_tailwind_modules$Tailwind$Utilities$z_20]))
				]),
			_List_fromArray(
				[
					$author$project$Main$viewTitle('Create'),
					A2(
					$rtfeldman$elm_css$Html$Styled$div,
					_List_fromArray(
						[
					...
					$author$project$Util$htmlAddedBrFromString('Add geolocation coordinate or a hiking trail\n (collection of coordinates) directly on \n Concordium blockchain.')),
					A2(
					$rtfeldman$elm_css$Html$Styled$div,
					_List_fromArray(
						[
					...
					_List_fromArray(
						[
							$rtfeldman$elm_css$Html$Styled$Attributes$css(
							_List_fromArray(
								[$matheus23$elm_default_tailwind_modules$Tailwind$Utilities$text_xs, $matheus23$elm_default_tailwind_modules$Tailwind$Utilities$text_gray_400, $matheus23$elm_default_tailwind_modules$Tailwind$Utilities$mt_6]))
						]),
					_List_fromArray(
						[
			...
			_List_fromArray(
				[
					$rtfeldman$elm_css$Html$Styled$Attributes$css(
					_List_fromArray(
						[$matheus23$elm_default_tailwind_modules$Tailwind$Utilities$p_10, $matheus23$elm_default_tailwind_modules$Tailwind$Utilities$text_center, $matheus23$elm_default_tailwind_modules$Tailwind$Utilities$z_20]))
				]),
			_List_fromArray(
				[
					$author$project$Main$viewTitle('Explore'),
					A2(
					$rtfeldman$elm_css$Html$Styled$div,
					_List_fromArray(
						[
					...
					$author$project$Util$htmlAddedBrFromString('Review your coordinates and trails \n stored on-chain \n by clicking the button below.')),
					A2(
					$rtfeldman$elm_css$Html$Styled$div,
					_List_fromArray(
						[
					...
					_List_fromArray(
						[
							$rtfeldman$elm_css$Html$Styled$text('System will load coordinates in a historic order from Concordium blockchain')
						]))
				]))
		]));
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$rtfeldman$elm_css$Html$Styled$Attributes$href('https://fonts.googleapis.com/css2?family=Open+Sans:wght@400;700&display=swap'),
